...
lib.ssMetadata = [
		{name:"369209 May Campaign_UK_ANIMATION_atlas_", frames: [[0,0,3302,2202],[3304,0,354,669],[3304,671,437,335]]}
];
...
(lib._369209MayCampaign_UK_ANIMATION = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:218.5,regY:-1354.5,x:287.5,y:249.5},0).wait(9).to({alpha:0.143},0).wait(1).to({alpha:0.286},0).wait(1).to({alpha:0.429},0).wait(1).to({alpha:0.571},0).wait(1).to({alpha:0.714},0).wait(1).to({alpha:0.857},0).wait(1).to({alpha:1},0).wait(209).to({alpha:0.933},0).wait(1).to({alpha:0.867},0).wait(1).to({alpha:0.8},0).wait(1).to({alpha:0.733},0).wait(1).to({alpha:0.667},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.533},0).wait(1).to({alpha:0.467},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.333},0).wait(1).to({alpha:0.267},0).wait(1).to({alpha:0.2},0).wait(1).to({alpha:0.133},0).wait(1).to({alpha:0.067},0).wait(1).to({alpha:0},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(28).to({_off:false},0).wait(1).to({regX:187,regY:334.5,x:841,y:1495.5,alpha:0.1},0).wait(1).to({alpha:0.2},0).wait(1).to({alpha:0.3},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.7},0).wait(1).to({alpha:0.8},0).wait(1).to({alpha:0.9},0).wait(1).to({alpha:1},0).wait(187).to({x:901},0).wait(1).to({x:961},0).wait(1).to({x:1021},0).wait(1).to({x:1081.1},0).wait(1).to({x:1141.1},0).wait(1).to({x:1201.1},0).wait(1).to({x:1261.1},0).wait(1).to({x:1321.1},0).wait(1).to({x:1381.1},0).wait(1).to({x:1441.1},0).wait(1).to({x:1501.1},0).wait(1).to({x:1561.2},0).wait(1).to({x:1621.2},0).wait(1).to({x:1681.2},0).wait(1).to({x:1741.2},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({_off:false},0).wait(6).to({x:1386.4},0).wait(1).to({x:1270.2},0).wait(1).to({x:1154},0).wait(1).to({x:1037.8},0).wait(1).to({x:921.6},0).wait(1).to({x:805.4},0).wait(1).to({x:689.3},0).wait(1).to({x:662.8},0).wait(1).to({x:636.4},0).wait(1).to({x:610},0).wait(12).to({x:609.9},0).wait(26).to({x:609.8},0).wait(27).to({x:609.7},0).wait(26).to({x:609.6},0).wait(26).to({x:609.5},0).wait(27).to({x:609.4},0).wait(26).to({x:609.3},0).wait(27).to({x:669.3},0).wait(1).to({x:729.3},0).wait(1).to({x:789.3},0).wait(1).to({x:849.3},0).wait(1).to({x:909.3},0).wait(1).to({x:969.3},0).wait(1).to({x:1029.3},0).wait(1).to({x:1089.4},0).wait(1).to({x:1149.4},0).wait(1).to({x:1209.4},0).wait(1).to({x:1269.4},0).wait(1).to({x:1329.4},0).wait(1).to({x:1389.4},0).wait(1).to({x:1449.4},0).wait(1).to({x:1509.5},0).wait(1));
